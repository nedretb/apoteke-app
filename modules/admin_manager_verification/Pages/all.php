...
if (@ver=1)
begin
SELECT department_code, parent2, parent3,c0_intranet2.dbo.fn_user_id(parent2) user1,c0_intranet2.dbo.fn_user_id(parent3) user2, c0_intranet2.dbo.fn_verified(c0_intranet2.dbo.fn_user_id(parent2)," . $_POST['IDMonth'] . ") verified1,c0_intranet2.dbo.fn_verified(c0_intranet2.dbo.fn_user_id(parent3)," . $_POST['IDMonth'] . ") verified2   FROM  " . $portal_users . "  where (c0_intranet2.dbo.fn_verified(c0_intranet2.dbo.fn_user_id(parent2)," . $_POST['IDMonth'] . ") =@ver) or (c0_intranet2.dbo.fn_verified(c0_intranet2.dbo.fn_user_id(parent3)," . $_POST['IDMonth'] . ") =@ver)  group by department_code, parent2, parent3
end
else
begin
SELECT department_code, parent2, parent3,c0_intranet2.dbo.fn_user_id(parent2) user1,c0_intranet2.dbo.fn_user_id(parent3) user2, c0_intranet2.dbo.fn_verified(c0_intranet2.dbo.fn_user_id(parent2)," . $_POST['IDMonth'] . ") verified1,c0_intranet2.dbo.fn_verified(c0_intranet2.dbo.fn_user_id(parent3)," . $_POST['IDMonth'] . ") verified2   FROM  " . $portal_users . "  where (c0_intranet2.dbo.fn_verified(c0_intranet2.dbo.fn_user_id(parent2)," . $_POST['IDMonth'] . ") =@ver) and (c0_intranet2.dbo.fn_verified(c0_intranet2.dbo.fn_user_id(parent3)," . $_POST['IDMonth'] . ") =@ver)  group by department_code, parent2, parent3
end");
        echo 'denis';
    }
            ...
            <div class="col-sm-12">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th><?php echo __('Verifikacija satnica'); ?></th>
                    ...
                    foreach ($query as $item) {
                        ...
                        if (isset($_POST['IDMonth'])) {
                            $get_verified = $db->query("select verified as verified from  " . $portal_hourlyrate_month . "  where user_id = " . $item['user_id'] . " and month=" . $idm);
                            $verified = $get_verified->fetch();
                            $verified_id = $verified['verified'];
