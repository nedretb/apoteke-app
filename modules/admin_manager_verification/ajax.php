...
if (isset($_POST['request'])) {
    ...
    if($_POST['request']=='generate-satnice'){
        ...
        foreach ($data_array as $data){
            $sumHourTotal = 0;
            $sumHourRe = $db->query("SELECT status, status_pre, hour, hour_pre, weekday, apoteke_status, apoteke_status_pre  FROM [c0_intranet2_apoteke].[dbo].[hourlyrate_day] where employee_no=".$userEmpNo[$count]." and month_id=".$month." and year_id=".$yearId[$count])->fetchAll();
