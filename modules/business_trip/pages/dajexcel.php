...
try{
    ...
    // -------------------------------------------------------------------------------------------------------------- //
    $sheet->SetCellValue('I5', "Sarajevo, ".date('d.m.Y'));

    $sheet->SetCellValue('J11', $data['fname'].' '.$data['lname']);
    $sheet->SetCellValue('L14', $data['position']);
    $sheet->SetCellValue('K16', Carbon::parse($data['pocetak_datum'])->format('d.m.Y'));
    $sheet->SetCellValue('I17', $data['odredisni_grad'].' , '.$drzava['name']);
