...
<?php }}?>
<a href="<?php echo '/apoteke-app/?m=business_trip&p=dajexcel&id='.$podatak['request_id'].'&sl_put_id='.$podatak['sl_put_id']; ?>"class="table-btn documents" target="_blank">Putni nalog</a>
