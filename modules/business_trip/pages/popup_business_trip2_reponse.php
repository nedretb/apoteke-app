...
<hr>
    ...
    <form id="popup_form" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="request" value="business-trip-request-response2"/>
      ...
      <label class="radio">
        <input type="radio" name="status_hr" value="1" checked="true">
        <i class="ion-android-checkbox-outline"></i><br>
        <?php echo __('Odobreno'); ?>
      </label>
      <label class="radio">
        <input type="radio" name="status_hr" value="2">
    ...
    <!--   <div class="col-sm-12">
     ...
     <!--  <label style="margin-left:10px;"><?php echo __('Odgovori:'); ?></label><br/>
      <textarea  name="comment_hr" style="margin:10px!important;width:98%;"></textarea>
 -->
      <hr/>
