 ...
 <section class="full">
  <div class="container" style="background-color:white";>
     ...
     <?php
      ...
      $query4 = $db->query("SELECT * FROM [c0_intranet2_apoteke].[dbo].[users] WHERE employee_no='".$user['to_admin']."'");
       ...
       foreach($query4 as $item4){
		 ...
		 $query5 = $db->query("SELECT * FROM [c0_intranet2_apoteke].[dbo].[users] WHERE employee_no='".$user['to_admin2']."'");
      
       foreach($query5 as $item4){
...
<hr>
    ...
    <form id="popup_form" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="request" value="business-trip-request-response-admin"/>
      ...
      <label class="radio">
        <input type="radio" name="status_admin" value="1" checked="true">
