    ...
    <div class="content clear">
        ...
        if ($get->rowCount() < 0) {
            ...
            <form id="popup_form" method="post">
                ...
                <input type="hidden" name="request" value="user-day-edit"/>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <select style="padding:0px !important;" name="FromDay" class="form-control" required>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select style="padding:0px !important; " name="status" id="status" class="form-control"
                                required>
                            <?php echo _optionHRstatusLevel3($row['status']); ?>
                        </select>
                    </div>
                </div>
                </br>

                <button id="buttontest" type="submit" onclick="getConfirmation();"
                        class="btn btn-red pull-right"><?php echo __('Spasi!'); ?> <i
