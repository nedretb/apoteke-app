...
<div class="mp-inside">
    ...
    <div class="mp-i-row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="email" class="form-control form-control-sm" id="inputEmail3" value="<?php echo $rs['doneseni_radni_staz_g']."g ".$rs['doneseni_radni_staz_m']."m ".$rs['doneseni_radni_staz_d']."d" ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-3 col-form-label mt-2"><?= ___('Radni staž u kompaniji: ') ?></label>
            <div class="col-sm-9">
                <input type="email" class="form-control form-control-sm" id="inputEmail3" value="<?php echo $rs['radni_staz_u_kompaniji_g']."g ".$rs['radni_staz_u_kompaniji_m']."m ".$rs['radni_staz_u_kompaniji_d']."d" ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-3 col-form-label mt-2"><?= ___('Ukupan radni staž: ') ?></label>
            <div class="col-sm-9">
                <input type="email" class="form-control form-control-sm" id="inputEmail3" value="<?php echo $rs['ukupan_radni_staz_g']."g ".$rs['ukupan_radni_staz_m']."m ".$rs['ukupan_radni_staz_d']."d" ?>">
            </div>
        </div>
