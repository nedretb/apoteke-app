            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $skol['strucna_sprema'] ?>" class="form-control form-control-sm" id="strucna_sprema" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="zavrsena_obrazovna_ustanova"><?= ___('Šifra stručnog zvanja') ?></label>
                        <input type="text" value="<?= $skol['sifra_strucnog_zvanja'] ?>" class="form-control form-control-sm" id="zavrsena_obrazovna_ustanova" readonly>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $skol['zvanje'] ?>" class="form-control form-control-sm" id="strucna_sprema" readonly>
                    </div>
                </div>
            </div>
        </div>
