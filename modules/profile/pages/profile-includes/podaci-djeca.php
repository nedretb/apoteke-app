            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $por['ime_prezime_djeteta'] ?>" class="form-control form-control-sm" id="bracni_status" readonly>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $por['spol'] ?>" class="form-control form-control-sm" id="supruznik_ime_prezime" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="supruznik_datum_rodjenja"> <?= ___('Datum rođenja djeteta') ?></label>
                        <input type="text" value="<?= date('d.m.Y', strtotime($por['datum_rodjenja'])) ?>" class="form-control form-control-sm" id="supruznik_datum_rodjenja" readonly>
                    </div>
                </div>
            </div>
        </div>
