            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $por['bracni_status'] ?>" class="form-control form-control-sm" id="bracni_status" disabled="disabled">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $por['supruznik_ime_prezime'] ?>" class="form-control form-control-sm" id="supruznik_ime_prezime" disabled="disabled">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="supruznik_datum_rodjenja"> <?= ___('Datum rođenja supružnika') ?></label>
                        <input type="text" value="<?= date('d.m.Y', strtotime($por['supruznik_datum_rodjenja'])) ?>" class="form-control form-control-sm" id="supruznik_datum_rodjenja" disabled="disabled">
                    </div>
                </div>
            </div>
        </div>
