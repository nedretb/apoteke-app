...
$data = $db->query("select * from [c0_intranet2_apoteke].[dbo].[sifarnik_kategorije_invalidnosti_go] where Active = 1");
$datao = $db->query("select * from [c0_intranet2_apoteke].[dbo].[sifarnik_kategorije_invalidnosti_go] where Active = 0");
...
<div class="container" style="width:100%;">
    <h2 style="display:flex; justify-content:center; padding:10px 0px 10px 0px;">Kategorije invalidnosti</h2>
...
<script>
    ...
    function addAjax(){
        $.ajax({
            type: 'POST',
            url: "<?php echo $url . '/modules/sifarniciorg/pages/kategorija_invalidnosti_req.php'; ?>",
            data: {type: 'add',
                category: $('#regija').val(),
