...
try{
    ...
    foreach($excelQuery as $user){
        ...
        $sporazum = $db->query("SELECT * FROM [c0_intranet2_apoteke].[dbo].[pm_sporazumi] where user_id = ".$usr['user_id']." and year = ".date('Y')." and f1_user IS NOT NULL and f2_user IS NULL")->fetch();
...
<div class="split-on-right">
    <div class="choose-what-to-do choose-what-to-do-full">
        ...
        <p>
            <a href="modules/performance_management/pages/pregled_statusa_2.xls" download> Izvještaj.xls </a>
            <a href="modules/performance_management/pages/pregled_statusa_2.xlsx" download> Izvještaj.xlsx </a>
        </p>
        <table>
            <thead>
            <tr>
