...
if(isset($_GET['id'])) {
    $id_of_a = $_GET['id'];
    $id_of_agreement = $db->query("SELECT * FROM [c0_intranet2_apoteke].[dbo].[pm_sporazumi] where id = ".$id_of_a)->fetchAll()[0];
}


if(isset($_POST['kategorija']) or isset($_GET['c_copy_it']) or isset($_GET['c_copy_itt'])){ require_once 'modules/performance_management/Pages/scripts/save_mbo.php'; } // Dodavanje novog cilja
if(isset($_GET['trigger_act_del']) or isset($_GET['trigger_act_dell'])){ require_once 'modules/performance_management/Pages/scripts/save_mbo.php'; }
if(isset($_GET['send_items']) or isset($_GET['send_items_f']) or isset($_POST['check_attr_id']) or isset($_POST['dev_plan'])){ require_once 'modules/performance_management/Pages/scripts/save_mbo.php'; }
        ...
        <div class="choose-what-to-do">
                    ...
                    foreach($predefined_goals as $goal){
                        ...
                        <tr>
                            ...
                            <td class="last-one" title="" style=" width: 120px;">
                                <a href="?m=performance_management&p=mbo_new_force&c_copy_itt=<?php echo $goal['id']; ?>&id=<?php echo $_GET['id']; ?>">
                    ...
                    <div class="single-element">
                        ...
                        <div class="edit-or-delete">
                            ...
                            <div class="action-button" title="Obrišite ovaj cilj !">
                                <a href="?m=performance_management&p=mbo_new_force&trigger_act_dell=<?php echo $goal['id']; ?>">Obrišite <i class="ion-ios-trash"></i></a>
                            </div>
                        </div>
                    </div>
                    <?php
            ...
            if(!$id_of_agreement['sent']){
                ...
                <div class="classic-button-wrapper">
                    <a href="?m=performance_management&p=mbo_new_force&send_items_f=true&id=<?= $_GET['id']; ?>">
