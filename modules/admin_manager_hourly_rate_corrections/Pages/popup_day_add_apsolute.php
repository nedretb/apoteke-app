        ...
        <form id="popup_form" method="post">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div id="dt">
                        <input type="text" name="dateFrom" class="form-control"  id="dateOD" value="01.<?php echo $_GET['month']; ?>.<?php echo $year['year']; ?>" placeholder="dd/mm/yyyy" title="" required>
                    </div><br/>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div id="dt">
                        <input type="text" name="dateTo" class="form-control"  id="dateDO" value="01.<?php echo $_GET['month']; ?>.<?php echo $year['year']; ?>" placeholder="dd/mm/yyyy" title="" required>
                    </div><br/>
                </div>
            </div>
        ...
        <script>
            $( document ).ready(function(){
                ...
                $('#dateDO').datepicker({
                    ...
                    language: 'bs',
                    startDate: startDate,
                    endDate: new Date(<?php echo date("Y"); ?> , (x.getMonth()+1), 0)
