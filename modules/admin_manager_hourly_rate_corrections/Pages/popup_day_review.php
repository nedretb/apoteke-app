    ...
    <div class="content clear">
        ...
        if ($get2->rowCount() < 0) {
            ...
            <form id="popup_form" method="post">
                ...
                <input type="hidden" name="status_id" value="<?php echo $row['corr_status']; ?>"/>
                <?php if ($row['corr_status'] != "5"): ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        if ((in_array($row['corr_status'], array(43, 44, 45, 61, 62, 65, 67, 68, 69, 73, 74, 75, 76, 77, 78, 81, 105, 107, 108, 91, 92, 93, 94, 95, 96, 85, 86, 87, 88, 89, 90)) and (($row['weekday'] == '6' or $row['weekday'] == '7')) or ($row['weekday'] != '6' and $row['weekday'] != '7') or (($row['weekday'] == '6' or $row['weekday'] == '7') and $row['hour'] > 0 and in_array($row['corr_status'], array(5, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96))))):
                ...
                <div style="display:<?php if ($row['employee_comment'] != '') {
                    echo '';
                } else {
                    echo 'none';
                } ?>">
                    <label><?php echo __('Komentar zaposlenika'); ?></label><br/>
                    <textarea name="komentar" id="komentar" class="form-control"
                              readonly><?php echo $row['employee_comment']; ?></textarea>
            ...
            <script>
                ...
                $("#popup_form").validate({
                    ...
                    submitHandler: function (form) {
                        $('.dialog-loader').show();
                        $(form).ajaxSubmit({
                            url: "<?php echo $url . '/modules/admin_manager_hourly_rate_corrections/ajax.php'; ?>",
                            type: "post",
