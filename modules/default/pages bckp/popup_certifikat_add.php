...
<section>
	<div class="content clear">
      ...
      <div id="certifikat">
        <input type="text" name="certifikat" class="form-control" placeholder="<?php echo __('Naziv završene edukacije / treninga'); ?>" title="Unesite naziv završene edukacije / treninga!"  required><br/>
      </div>
	  
	 <label><?php echo __('Naziv institucije:'); ?></label>
      <div id="institucija">
        <input type="text" name="institucija" class="form-control" placeholder="<?php echo __('Naziv institucije'); ?>" title="Unesite naziv institucije!" required><br/>
      </div>
