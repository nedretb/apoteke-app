        ...
        <div class="row">
          ...
          <div class="col-sm-3 text-right">
            ...
            <?php if($item['status'] == 1){ ?>
                ...
                <a target="_blank" href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_vacation_request_pdf2018_new.php?id='.$tools_id; ?>" style="width:180px;"  class="table-btn"><i style="font-size:16px;" class="ion-ios-copy-outline"></i> Preuzmite rješenje </a>
            <?php }else{ ?>
