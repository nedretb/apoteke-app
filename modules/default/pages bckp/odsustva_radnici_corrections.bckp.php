...
<section class="full">
 ...
 <button type="submit" class="btn btn-red "><?php echo __('Pretraži!'); ?> <i class="ion-ios-download-outline"></i></button>     
	  ...
	  <div class="col-sm-2" style="width:13%;">
		 <button class="btn btn-allow" id="accept_all" style="width:150px; height:34px; textalign:left;"><?php echo __('Odobri izostanke'); ?> <i class="fa fa-check" style = "padding-top:3px;" aria-hidden="true"></i></button>
	  </div>
