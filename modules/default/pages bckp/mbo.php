      ...
      <div class="col-sm-2">
        <div class="box" style="background:none;">
			   ...
			   <?php if($_user['image_no'] != 'none'){ ?>
					...
					<img src="<?php echo $_uploadUrl; ?>/<?php echo _user($usr)['image']; ?>" class="" style="width:65%;">
                  <?php }else{ ?>
                    <img src="<?php echo $_themeUrl; ?>/images/noimage-user.png" class="img-circle" style="width:65%;">
                  <?php } ?>
				  </div>
				  </div>
				  </div>
...
?>
	 	 ...
	 	 if($_user['role'] == '1' || $_user['role'] == '2'){?>
                 ...
                 <select id="opcije_mbo" name="opcije_mbo" class="rcorners1" class="form-control" style = "height:37px;outline:none;"  >
     <?php if(isset($_GET['u'])){$opcija=0;}else{$opcija=1;}
	 echo _optionMBOProfilHR($opcija); ?>
		 ...
		 <?php }else{?>
                 ...
                 <select id="profil" name="profil" class="rcorners1" class="form-control" style = "height:37px;outline:none;display:none;"  >
     <?php echo _optionMBOProfil(0); ?>
					...
					<div id="name_search" style="display:<?php if(isset($_GET['u'])) {echo '';}else{echo 'none';} ?>;width:225px;padding-top: 34px;"  class="col-sm-2">
        <form action="" method="get" class="">
          ...
          <select name="u" id="select_input" class="pull-right rcorners1" class="" style="width:400px;height:37px;padding-top:0px;padding-bottom:0px;" onchange="this.form.submit();">
	  ...
	  <div id="name_search1" style="display:none;width:225px;padding-top: 34px;"  class="col-sm-2">
        <form action="" method="get" class="">
          ...
          <select name="u" id="select_input1" class="pull-right rcorners1" class="" style="width:400px;height:37px;padding-top:0px;padding-bottom:0px;" onchange="this.form.submit();">
            <option value=""><?php echo __('Odaberi'); ?></option>
            <?php
              $_user_role = $_user['role'];
              if($_user_role==1){
	...
	?>
		...
		<div class = "col-sm-6">
				<span style="height:20px; background: #FFC000;color: black;padding-left:20px;display:block;"><b>Talent  pool</b></span><br/>
				  ...
				  <label><?php echo __('Rizik gubitka'); ?></label>
			           <select style="float:right" id="rizik_gubitka" name="<?php echo 'rizik_gubitka-'.$item['user_id']; ?>" class="" class="form-control"  >
     <?php echo _OptionRizikGubitka($rizik_gubitka); ?>
      </select>
	       </div>
		   <div style="margin-bottom:5px;" class = "">
		  <label><?php echo __('Uticaj gubitka'); ?></label>
			           <select style="float:right" id="uticaj_gubitka" name="<?php echo 'uticaj_gubitka-'.$item['user_id']; ?>" class="" class="form-control"  >
     <?php echo _OptionUticajGubitka($uticaj_gubitka); ?>
      </select>
	  </div>
	      <div style="margin-bottom:5px;" class = "">
		  <label><?php echo __('Mogući razlog odlaska'); ?></label>
			           <select style="float:right" id="razlog_odlaska" name="<?php echo 'razlog_odlaska-'.$item['user_id']; ?>" class="" class="form-control"  >
     <?php echo _OptionRazlogOdlaska($razlog_odlaska); ?>
      </select>
	      </div>
		   <div style="margin-bottom:5px;" class = "">
		  <label><?php echo __('Karijera'); ?></label>
			           <select style="float:right" id="karijera" name="<?php echo 'karijera-'.$item['user_id']; ?>" class="" class="form-control"  >
     <?php echo _OptionKarijera($karijera); ?>
      </select>
	  </div>
	       <div style="margin-bottom:5px;" class = "">
		  <label><?php echo __('Novi zaposlenik'); ?></label>
			           <select style="float:right" id="novi_zaposlenik" name="<?php echo 'novi_zaposlenik-'.$item['user_id']; ?>" class="" class="form-control"  >
     <?php echo _OptionNoviZaposlenik($novi_zaposlenik); ?>
		...
		<div class = "col-sm-6">
			...
			<input type="text" style="float:right" id="pozicija" name="<?php echo 'pozicija-'.$item['user_id']; ?>" value="<?php echo $pozicija; ?>" spellcheck="false"></input>
			     </div>
				
				 
				  <div style="margin-bottom:5px;" class = "">
				  <label><?php echo __('Spremnost za preuzimanje pozicije'); ?></label>
			           <select style="float:right" id="spremnost" name="<?php echo 'spremnost-'.$item['user_id']; ?>" class="" class="form-control"  >
     <?php echo _OptionSpremnost($spremnost); ?>
	   ...
	   <label><?php echo __('Prezime i ime'); ?></label>
			<input type="text" style="float:right" id="prezime_ime" name="<?php echo 'prezime_ime-'.$item['user_id']; ?>" value="<?php echo $prezime_ime; ?>" spellcheck="false"></input><br/>
			 </div>  
			   
			   <div style="margin-bottom:5px;" class = "">
			   <label><?php echo __('Datum'); ?></label>
			   <input style="width: 115px;height: 30px;display: initial;float:right;border-bottom-style: groove;;border-style: groove;" type="text" id="datum" name="<?php echo 'datum-'.$item['user_id']; ?>" class="form-control" id="date_to" placeholder="dd/mm/yyyy" value="<?php if( $datum!=''){echo date('d/m/Y',strtotime($datum));} else{echo '';} ?>">
			   </div>
			   <br/><br/><br/>
			   </div>
			   <?php } ?>
			   
			   <div class="btn btn-filter active-task" style="margin-bottom:15px;width: 185px;margin-left:15px;"> <a style="color:black" class="active-white" href="#karijera_pozicija"> Karijera i ostale vještine</a><a style = "margin-left:5px;" href="#karijera_pozicija"><i class="fa fa-arrow-down" style="color:white;" aria-hidden="true"></i></a></div>
	...
	<th style="height:20px; background: #c7bebe;color: black;width: 20px;" ></th> 	
			 ...
			 <tr>
				...
				<td><a href="<?php echo $url.'/modules/'.$_mod.'/ajax.php'; ?>" class="table-btn1" data-widget="remove" data-id="experience_remove:<?php echo $item['id']; ?>" data-text="<?php echo __('Dali ste sigurni da želite poništiti radno iskustvo?'); ?>" title = "Obriši" style="display:<?php if(isset($_GET['u'])) {echo 'none';}else{echo '';} ?>"><i class="ion-android-close"></i></a></td>
			...
			<?php }?>	
			   ...
			   <a href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_experience_add.php'?>" data-widget="ajax" data-id="opt2" data-width="1500" class="btn btn-sm btn-red" style="margin-bottom:5px;float: left;background: cadetblue;display:<?php if(isset($_GET['u'])) {echo 'none';}else{echo '';} ?>">Novi unos <i class="ion-ios-plus-empty"></i></a>
			   <br/> <br/>
			   </div>
	...
	<th style="height:20px; background: #c7bebe;color: black;width: 20px;" ></th>
			 ...
			 <tr>
				...
				<td><a href="<?php echo $url.'/modules/'.$_mod.'/ajax.php'; ?>" class="table-btn1" data-widget="remove" data-id="project_remove:<?php echo $item['id']; ?>" data-text="<?php echo __('Dali ste sigurni da želite poništiti projekt?'); ?>" title = "Obriši" style="display:<?php if(isset($_GET['u'])) {echo 'none';}else{echo '';} ?>"><i class="ion-android-close"></i></a></td>
			...
			<?php }?>	
			   ...
			   <a href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_project_add.php'?>" data-widget="ajax" data-id="opt2" data-width="1500" class="btn btn-sm btn-red" style="margin-bottom:5px;float: left;background: cadetblue;display:<?php if(isset($_GET['u'])) {echo 'none';}else{echo '';} ?>">Novi unos <i class="ion-ios-plus-empty"></i></a>
			     <br/> <br/>
			   </div>
	...
	<th style="height:20px; background: #8DB4E2;color: #ffffff;width: 300px;" ></th> 
	 	   ...
	 	   <tr>
    <th style="height:20px; background: #c7bebe;color: black;width: 300px;">Naziv završene obrazovne institucije</th>
	...
	<th style="height:20px; background: #c7bebe;color: black;width: 300px;" >Zvanje</th> 
			 ...
			 <tr>
                ...
                <td nowrap="nowrap"><?php echo $item['stepen']; ?></td>
				 ...
				 <td nowrap="nowrap"><?php if($item['date_from']!='') {echo date('d/m/Y',strtotime($item['date_from']));}else{echo '';} ?></td>
                <td nowrap="nowrap"><?php if($item['date_to']!='') {echo date('d/m/Y',strtotime($item['date_to']));}else{echo '';} ?></td>
	...
	<th style="height:20px; background: #c7bebe;color: black;width: 20px;" ></th>	
			...
			<?php
			 ...
			 <tr>
				...
				<td><a href="<?php echo $url.'/modules/'.$_mod.'/ajax.php'; ?>" class="table-btn1" data-widget="remove" data-id="language_remove:<?php echo $item['id']; ?>" data-text="<?php echo __('Dali ste sigurni da želite poništiti jezik?'); ?>" title = "Obriši" style="display:<?php if(isset($_GET['u'])) {echo 'none';}else{echo '';} ?>"><i class="ion-android-close"></i></a></td>
              </tr>

			<?php }?>	
			  
			   </table>
			   <a href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_language_add.php'?>" data-widget="ajax" data-id="opt2" data-width="1500" class="btn btn-sm btn-red" style="margin-bottom:5px;float: left;background: cadetblue;display:<?php if(isset($_GET['u'])) {echo 'none';}else{echo '';} ?>">Novi unos <i class="ion-ios-plus-empty"></i></a>
			     <br/> <br/>
			   </div>
	...
	<th style="height:20px;width: 20px;" ></th> 
	 	   ...
	 	   <tr>
    <th style="height:20px; background: #c7bebe;color: black;width: 300px;">Naziv završene edukacije / treninga</th>
	...
	<th style="height:20px; background: #c7bebe;color: black;width: 20px;" ></th>	
			 ...
			 <tr>
				...
				<td><a href="<?php echo $url.'/modules/'.$_mod.'/ajax.php'; ?>" class="table-btn1" data-widget="remove" data-id="certifikat_remove:<?php echo $item['id']; ?>" data-text="<?php echo __('Dali ste sigurni da želite poništiti certifikat?'); ?>" title = "Obriši" style="display:<?php if(isset($_GET['u'])) {echo 'none';}else{echo '';} ?>"><i class="ion-android-close"></i></a></td>
				</tr>
			...
			<?php }?>	
			   ...
			   <a href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_certifikat_add.php'?>"  data-widget="ajax" data-id="opt2" data-width="1500" class="btn btn-sm btn-red" style="margin-bottom:5px;float: left;background: cadetblue;display:<?php if(isset($_GET['u'])) {echo 'none';}else{echo '';} ?>">Novi unos <i class="ion-ios-plus-empty"></i></a>
			     <br/> <br/>
			   </div>
		...
		<div id="karijera_pozicija" class = "col-sm-6">
			...
			<textarea id="ambicije" <?php if(isset($_GET['u'])) {echo 'readonly';} ?> style="float:right;height:100px;" rows="3" cols="70" name="<?php echo 'ambicije-'.$item['user_id']; ?>" spellcheck="false"><?php echo $ambicije; ?></textarea>
			     </div>
				  <div style="margin-bottom:5px;" class = "">
				<label><?php echo __('Mobilnost (DA / NE)'); ?></label>
			           <select <?php if(isset($_GET['u'])) {echo 'disabled';} ?> style="float:right;" id="mobilnost" name="<?php echo 'mobilnost-'.$item['user_id']; ?>" class="" class="form-control"  >
     <?php echo _OptionVerification($mobilnost); ?>
      </select>
	  </div>
			       <div style="margin-bottom:5px;" class = "">
				  <label><?php echo __('Željena lokacija'); ?></label>
			<input type="text" <?php if(isset($_GET['u'])) {echo 'disabled';} ?> style="float:right;" id="lokacija" name="<?php echo 'lokacija-'.$item['user_id']; ?>" spellcheck="false" value="<?php echo $lokacija; ?>"></input><br/>
			   </div>
			   </div>
		...
		<div class = "col-sm-6">
			...
			<input type="text" <?php if(isset($_GET['u'])) {echo 'disabled';} ?> style="float:right;" id="vjestina" name="<?php echo 'vjestina-'.$item['user_id']; ?>" value="<?php echo $vjestina; ?>" spellcheck="false"></input><br/>
			     </div>
				<div style="margin-bottom:5px;" class = "">
				<label><?php echo __('Nivo'); ?></label>
			<input type="text" <?php if(isset($_GET['u'])) {echo 'disabled';} ?> style="float:right;" id="nivo" name="<?php echo 'nivo-'.$item['user_id']; ?>" value="<?php echo $nivo; ?>" spellcheck="false"></input><br/>
			   </div>
			   <br/><br/>
			   <div class="btn btn-filter active-task" style="margin-bottom:15px;width: 185px;margin-left:15px;"> <a style="color:black" class="active-white" href="#c1a"> Nazad na početak</a><a style = "margin-left:5px;" href="#c1a"><i class="fa fa-arrow-up" style="color:white;" aria-hidden="true"></i></a></div>
			   <br/><br/><br/>
			   </div>
...
<?php
 ...
 <script>
			...
			$('#ambicije').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-ambicije", ambicije : this.value, user_id : this.name}, 
    function(returnedData){
		...
		$('#mobilnost').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-mobilnost", mobilnost : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
		...
		$('#lokacija').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-lokacija", lokacija : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
		...
		$('#vjestina').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-vjestina", vjestina : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
		...
		$('#nivo').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-nivo", nivo : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#rizik_gubitka').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-rizik_gubitka", rizik_gubitka : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#uticaj_gubitka').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-uticaj_gubitka", uticaj_gubitka : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#razlog_odlaska').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-razlog_odlaska", razlog_odlaska : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#karijera').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-karijera", karijera : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#novi_zaposlenik').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-novi_zaposlenik", novi_zaposlenik : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#pozicija').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-pozicija", pozicija : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#spremnost').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-spremnost", spremnost : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#prezime_ime').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-prezime_ime", prezime_ime : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
			...
			$('#datum').on('change', function() {
				...
				$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "change-datum", datum : this.value, user_id : this.name}, 
    function(returnedData){
		//$('#poslovnice').html(returnedData);
