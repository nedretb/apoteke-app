...
<section class="full tasks-page">
  ...
  <div class="container-fluid">
        ...
        <div class="box">
			...
			if($item['phase']==3)
			   ...
			   if($_user['image'] != 'none'){ /* ?>
					...
					<img src="<?php echo $_uploadUrl; ?>/<?php echo $_user['image']; ?>" class="" style="width:100%;">
                  <?php }else{ ?>
				...
				<div class="btn btn-filter active-task" style="margin-bottom: 15px;width: 130px;"> <a style="color:black" class="active-black" href="?m=default&amp;p=mbo&f=0"> Moj MBO Profil</a></div>
				  </div>
				    <div class="col-sm-2">
				<div class="btn btn-filter active-task" style="margin-bottom: 15px;width: 130px;"> <a style="color:black" class="active-black" href="?m=default&p=tasks&f=1"> Postavljanje ciljeva</a></div>
				  </div>
    ...
    <span style="height:20px;width: 969px;padding-left: 10px;display:block">To-do lista</span><br/><br/>
    <label style="height:20px; background: #FFC000;color: #ffffff;width: 969px;padding-left: 10px;">Rok</label><br/><br/>
	<div class = "col-sm-4">	
	...
	echo '<label style="height:20px;color: red;width: 400px;">'.date('d/m/Y',strtotime($evaluacija)).'</label><br/><br/><br/>';
			...
			<label style="height:20px;color: black;width: 90px;"><i class="fa fa-exclamation-circle" aria-hidden="true" style="color:red;margin-right:6px;"></i>Rok istekao</label>
			<label style="height:20px;color: black;width: 60px;"><i class="fa fa-circle-o" aria-hidden="true" style="color: darkorange;margin-right:3px;"></i>U toku</label>
			<label style="height:20px;color: black;width: 140px;"><i class="fa fa-clock-o" aria-hidden="true" style="color:blue;margin-right:6px;"></i>Poslano na pregled</label>
			<label style="height:20px;color: black;width: 100px;"><i class="fa fa-circle-o" aria-hidden="true" style="color:gray;margin-right:3px;"></i>Nije spremno</label>
			<label style="height:20px;color: black;width: 90px;"><i class="fa fa-check-circle" aria-hidden="true" style="color:green;margin-right:6px;"></i>Završeno</label>
			        ...
			        <div class = "col-sm-4">
					 <span style="height:20px;width: 400px;padding-left: 10px;display:block;">Linkovi</span><br/><br/>
					...
					<span style="height:20px;width: 400px;padding-left: 10px;display:block">Dobrodošli</span><br/><br/>
					<label style="height:20px;color: black;width: 400px;"><b>Dobrodošli u MBO sistem za upravljanje radnim učinkom!</b></label><br/>
					<label style="height:20px;color: black;width: 400px;"><u>Sistem je namijenjen za postavljanje ciljeva, upravljanje</u></label><br/>
					<label style="height:20px;color: black;width: 400px;"><u>radnim učinkom i planiranje razvoja zaposlenika.</u></label><br/>
					<label style="height:20px;color: black;width: 400px;">_</label><br/>
					<label style="height:20px;color: black;width: 400px;">Više informacija o procesu upravljanja radnim</label><br/>
...
<img border="0" alt="W3Schools" src="<?php echo $_uploadUrl.'/word_ciljevi.png'; ?>" width="" height="">
</a>
			   </div>
			   </div>
    ...
    <th style="height:10px;width: 100px;" >Ponder (%)</th> 
				  ...
				  <?php
				  foreach($query as $item){ if($item['status'] != '4' and $item['status'] != '5' and $item['ponder'] != '0' and $item['ponder'] != '' ){?>
				
				<tr>
                <td><input readonly="readonly" type="text" class="rcorners1" style="width:500px;" name="oj[]" value="<?php echo $item['task_name']; ?>"></td>
				<td><input readonly="readonly" type="text" class="rcorners1" style="width:200px;" name="oj[]" value="<?php echo $item['KPI']; ?>"></td>
				<td><input readonly="readonly" type="text" class="rcorners1" style="width:100px;" name="item_description[]" value="<?php echo date('d/m/Y', strtotime($item['date_end'])); ?>"></td>
				<td><input readonly="readonly" type="text" class="rcorners1" style="width:100px;" name="oj[]" value="<?php echo $item['ponder']; ?>"></td>
                </tr>
				  <?php 
		...
		<?php echo '<label class = "mbo-font" style="width:200px;margin-left:854px;"><b>Ukupno</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ponder_sum.' %</label>'; }else { 
