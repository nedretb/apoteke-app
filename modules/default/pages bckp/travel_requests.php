...
<section class="full">
 ...
 <a href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_travel_requests_add.php'; ?>" data-widget="ajax" data-id="opt2" data-width="500" class="btn btn-red btn-lg"><?php echo __('Novi unos'); ?> <i class="ion-ios-plus-empty"></i></a>
        </div>
      </div>
...
$total = $get2->rowCount();
    ...
    <a href="/app/?m=default&p=travel_requests" class="btn btn-filter <?php if($type == ''){ echo 'active'; } ?>"><?php echo __('Aktivni'); ?></a>
    <a href="/app/?m=default&p=travel_requests&t=3" class="btn btn-filter <?php if($type == '3'){ echo 'active'; } ?>"><?php echo __('Arhiva'); ?></a>
