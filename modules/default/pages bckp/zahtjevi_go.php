...
<section class="full">
  ...
  <div class="container-fluid">
	...
	$queryq = $db->query("select *  from [NAV RAIFFEISEN].[dbo].[RAIFFAISEN BANK".'$'."Vacation Ground 2]
  where [Employee No_]=".$_user['employee_no']);
      ...
      <div class="content">
        ...
        <div class="col-sm-5">
         <?php echo __('Rješenje o korištenju godišnjeg odmora'); ?>
            ...
            <?php echo __('Od:'); ?> <b><?php echo date('d.m.Y',strtotime($item['Starting Date of I part'])); ?></b> &nbsp;
            <?php echo __('Do:'); ?> <b><?php echo date('d.m.Y',strtotime($item['Ending Date of I part'])); ?></b>
        ...
        <?php echo date('d.m.Y',strtotime($item['Insert Date'])); ?> 
          ...
          <?php 
          if($item['Year'] == 2018 ){ ?>
                <a target="_blank" href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_vacation_request_pdf2018_new.php?id='.$item['id']; ?>" style="width:180px;"  class="table-btn"><i style="font-size:16px;" class="ion-ios-copy-outline"></i> Preuzmite rješenje </a>
          <?php } 
          else if($item['Year'] == 2019 ){ ?>
                <a target="_blank" href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_vacation_request_pdf_new.php?id='.$item['id']; ?>" style="width:180px;"  class="table-btn"><i style="font-size:16px;" class="ion-ios-copy-outline"></i> Preuzmite rješenje </a>
          <?php } 
          else if($item['Year'] == 2020 ){ ?>
                <a target="_blank" href="<?php echo $url.'/modules/'.$_mod.'/pages/popup_vacation_request_pdf_new2020.php?id='.$item['id']; ?>" style="width:180px;"  class="table-btn"><i style="font-size:16px;" class="ion-ios-copy-outline"></i> Preuzmite rješenje </a>
          <?php } 
