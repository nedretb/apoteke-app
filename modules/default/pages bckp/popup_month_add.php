...
<section>
	...
	<div class="content clear">
		...
		<form id="popup_form" method="post">
			...
			<input type="hidden" name="request" value="month-add"/>
     <input type="hidden" name="year" value="<?php echo $_GET['year']; ?>"/>


      <select id = "month" name="month" class="form-control" required>
        <?php echo _optionMonth(0); ?>
      </select><br/>
    ...
    <script src="<?php echo $_pluginUrl; ?>/validation/jquery.form.js"></script>
	  ...
	  max: <?php echo $num_users; ?>
			...
			function myTimer() {
   							$.get("<?php echo $url.'/modules/default/ajax_get.php'; ?>", { request: "check-month-add", month : $('#month').val()}, 
