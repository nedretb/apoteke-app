...
<section>
	<div class="content clear">
      ...
      <div id="task">
        <input type="text" style="width:300px;" name="task_name" class="form-control" placeholder="<?php echo __('Naziv Cilja'); ?>" spellcheck="false" required><br/>
      </div>
	  
	  <label><?php echo 'Opis cilja:'; ?></label>
      <div id="task">
        <textarea maxlength="350" rows="3" cols="50" name="task_description" placeholder = "Unesite opis cilja..." title="Max 350 karaktera" spellcheck="false"></textarea>
      </div>
	  
	  <?php if($task_type !=2) {?>
	  <label><?php echo 'KPI:'; ?></label>
      <div id="kpi">
        <textarea maxlength="350" rows="3" cols="30" name="task_kpi" placeholder = "Unesite KPI..." title="Max 350 karaktera" spellcheck="false"></textarea>
      </div>
	   <?php }?>
      ...
      <div id="ponder1" class = "" style="width:160px;display: -webkit-box;">
       <input style="width:90px;height:30px;margin-right:10px;" type="text" id="ponder" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="ponder" title="Min - 5%, Max - 30%" class="form-control" placeholder="<?php echo __('Ponder'); ?>" required><label style="margin-right:35px;">%</label><label>Preostalo pondera : </label><div id="preostalo_ponder"></div><label>%</label><br/>
      </div>
