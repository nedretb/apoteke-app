	...
	<!--- <div class="col-sm-1" style = "width:17%">
	 ...
	 <button id = "export_pdf" class="btn btn-pdf"><?php echo __('Exportuj u PDF!'); ?> <i class="fa fa-file-pdf-o" style = "padding-top:3px;" aria-hidden="true"></i></button>    
            ...
            <!--  <div style="margin-left:20px;">
				<div class="small-circle" style="background:#ccc;"></div> <?php echo __('Spašeno'); ?>
...
window.open(url);
		  ...
		  $("#export_excel_users").click( function()
           {
            			$.post("<?php echo $url.'/modules/default/ajax.php'; ?>", { request: "export-excel-reif-users",year: <?php echo $year['id'];?>, month_from : <?php echo $month_from;?>, month_to : <?php echo $month_to;?>, day_from : <?php echo $day_from;?>, day_to : <?php echo $day_to;?>}, 
    function(url){
window.open(url);
});
           }
