...
<section class="full">
  ...
  <div class="containers" style="width:100%;">
	...
	<div class="row">
      ...
      <div class="row col-sm-12" style="margin-left:-0.2%;">
		...
		<input type="text" name="dateFrom" class="form-control" style="height:35px;" id="dateOD1" placeholder="dd.mm.yyyy" title="" value="<?php if(isset($_POST['dateFrom'])) {echo date('d.m.Y',strtotime(str_replace("/","-",$_POST['dateFrom'])));} else {echo date('d.m.Y',strtotime("01-".$month_from."-".$year['year']));}?>">
     <br/>
        </div>
      
		<div class="col-sm-1" style="padding: 0 3px;">
		<input type="text" name="dateTo" class="form-control" style="height:35px;" id="dateDO1" placeholder="dd.mm.yyyy" title="" value="<?php if(isset($_POST['dateTo'])) {echo date('d.m.Y',strtotime(str_replace("/","-",$_POST['dateTo'])));} else {echo date('d.m.Y',strtotime($number_of_days."-".$month_to."-".$year['year']));}?>" >
     <br/>
        </div>
		 <div class="col-sm-1" style="padding: 0 3px;" >
 ...
 <button type="submit" class="btn btn-red "><?php echo __('Pretraži!'); ?> <i class="ion-ios-download-outline"></i></button>     
	...
	<div class="col-sm-2" style="max-width: 162px;margin-left: 7px;">
		 <button class="btn btn-allow" id="accept_all" style="width:150px; height:34px; text:align:left;"><?php echo __('Odobri izostanke'); ?> <i class="fa fa-check" style = "padding-top:3px;font-size: 12px;padding-top: 10px;" aria-hidden="true"></i></button>
	  </div>
	<?php endif; ?>
	  <!--<div class="col-sm-1" style="    max-width: 90px;" >
	  <button class="btn btn-primary" id="open_export" style="width:auto; height:34px;    max-width: 85px;"><?php echo __('Export'); ?> <i class="fa fa-download" style = "padding-top:3px;font-size: 12px;padding-top: 10px; " aria-hidden="true"></i></button>
