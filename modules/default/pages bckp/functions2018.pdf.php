...
///////////////////// END CONFIG
	...
	if($state == 'fbih'){
		...
		<ol style="padding-left:0;">
			<li>Radnik/ca banke '. $data['fname'].' '. $data['lname'].', JMBG: '. $data['JMB'].', zaposlen/a na radnom mjestu '. $data['position'].', ostvaruje pravo na korištenje godišnjeg odmora za ' . date('Y',strtotime($data['Insert Date'])) .  '. godinu u trajanju od ' . $data['Total days'] . ' radna dana prema sljedećim kriterijima:<br />
			<ul>
