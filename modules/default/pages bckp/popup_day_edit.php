...
<section>
    ...
    ?>
      ...
      <div class="row">
	   ...
	   <div class="row" <?php  if($_user['B_1_regions_description']!='Kontakt centar' or $_user['B_1_regions_description']=='Kontakt centar' ) {echo 'style="display:none;"';} ?>>
        <div class="col-sm-2">
          <!-- <label><?php echo __('Dan'); ?></label>
	  ...
	  <button id="nalog" onclick=(alemfunction(event,<?php  echo $_GET['id'];?>)) class="btn btn-red pull-right"><?php echo __('Otvori nalog!'); ?> <i class="ion-ios-download-outline"></i></button>
</form>
