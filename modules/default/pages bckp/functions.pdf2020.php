...
///////////////////// END CONFIG
	...
	if($state == 'fbih'){
		...
		$_text[0] = "Na osnovu odredaba Zakona o radu Republike Srpske i Pravilnika o radu Radu Raiffeisen Bank dd Bosna I Hercegovina, donosim";
		...
		<ol style="padding-left:0;">
			<li>Radnik Banke '. $data['fname'].' '. $data['lname'].', JMBG: '. $data['JMB'].', zaposlen/a na radnom mjestu '. $data['position'].' (Udaljem tekstu Radnik) ostvaruje pravo na korištenje godišnjeg odmora za ' . date('Y',strtotime($data['Insert Date'])) .  '. godinu u trajanju od ' . $data['Total days'] . ' radna dana prema sljedećim kriterijima:<br />
			<ul>
			...
			<li>Preostali dio godišnjeg odmora Radnik će koristiti u dogovoru sa poslodavcem, a najkasnije do 30. juna ' . date('Y',strtotime($data['Insert Date']. " + 1 year")).  '. godine.<br /></li>
			<li>Radnik ima pravo koristiti jedan dan godišnjeg odmora kad to želi, uz obavezu da o tome obavijesti poslodavca najmanje tri dana prije njegovog korištenja.<br /></li>
			<li>Za vrijeme korištenja godišnjeg odmora Radnik ima pravo na naknade u skladu sa pozitivno pravnim propisima.<br /></li>
		</ol>
		...
		Planom korištenja godišnjeg odmora, a u skladu sa prethodnog usaglašenim terminom korištenja godišnjeg odmora između nadležnog rukovodioca i Radnika, predviđeno je da Radnik koristi godišnji odmor u vrijeme navedeno u dispozitivu ovog Rješenja.
		
		<br />
		<br />
		
		Za vrijeme korištenja godišnjeg odmora Radnik ima pravo na naknade u skladu sa pozitivno pravnim propisima.
		...
		Radnik, ako smatra da mu je ovom Odlukom povrijeđeno neko pravo iz radnog odnosa, ima pravo podnijeti pisani zahtjev Poslodavcu da mu osigura ostvarivanje tog prava u roku od 30 dana od dana saznanja za povredu, a najduže u roku od 3 mjeseca od dana učinjene povrede.
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
