...
$pdf->CoonsPatchMesh(20, 155, 80, 80, $blue, $blue, $green, $red);
...
$pdf->CoonsPatchMesh(110, 155, 80, 80, $blue, $blue, $green, $red, $coords, $coords_min, $coords_max);
