...
$pdf->AddSpotColor('My TCPDF Light blue', 0, 0, 55, 0);
...
$pdf->AddSpotColor('My TCPDF blue', 0, 20, 100, 0);
...
$starty += 24;
$pdf->SetFillSpotColor('My TCPDF Light blue', 100);
$pdf->Rect(30, $starty, 40, 20, 'DF');
$pdf->Text(73, $starty + 8, 'My TCPDF Light blue');
