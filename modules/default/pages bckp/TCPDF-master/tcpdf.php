...
class TCPDF {
	 ...
	 * @param $y (float) blue color for CMYK. Value between 0 and 100.
	...
	public function setColorArray($type, $color, $ret=false) {
		if (is_array($color)) {
			...
			// component: RGB blue or CMYK blue
	 ...
	 * @param $col3 (float) BLUE color for RGB (0-255), or blue color for CMYK (0-100).
	 ...
	 * @param $colors (string) colors to print separated by comma. Valid values are: A,W,R,G,B,C,M,Y,K,RGB,CMYK,ALL,ALLSPOT,<SPOT_COLOR_NAME>. Where: A = grayscale black, W = grayscale white, R = RGB red, G RGB green, B RGB blue, C = CMYK cyan, M = CMYK magenta, Y = CMYK blue, K = CMYK key/black, RGB = RGB registration color, CMYK = CMYK registration color, ALL = Spot registration color, ALLSPOT = print all defined spot colors, <SPOT_COLOR_NAME> = name of the spot color to print.
	 * @author Nicola Asuni
