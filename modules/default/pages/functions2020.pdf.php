...
///////////////////// END CONFIG
    ...
    $html = '
		...
		<p style="text-align:center;font-weight:bold;font-family: times;">
		<strong>RJEŠENJE<br />
		...
		<ol style="padding-left:0;">
			<li>Radnik Banke ' . $data['First Name'] . ' ' . $data['Last Name'] . ', JMBG: ' . $data['JMB'] . ', (U daljem tekstu: Radnik) ostvaruje pravo na korištenje godišnjeg odmora za ' . date('Y', strtotime($data['Insert Date'])) . '. godinu u trajanju od ' . $data['Total days'] . ' radna dana prema sljedećim kriterijima:<br />
			<ul>
				<li>U skladu sa Zakonom o radu - ' . $data['Legal Grounds'] . ' radnih dana;</li>
				<li>U skladu sa Pravilnikom o radu - ' . $pravilnik_o_radu . ' radnih dana.</li>
			</ul>
			<br />
			</li>
		...
		<br />
		<font style="text-align:left;font-weight:bold;font-family: times;">Emina Sarač</font><br />
		Direktor Kadrovskih poslova<br />
		
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p style="text-align:left;font-weight:bold;font-family: times;">Dostaviti:</p><br />
		1. ' . $_text[3] . '<br />
		2. a/a
