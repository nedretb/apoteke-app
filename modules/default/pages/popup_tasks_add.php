...
<section>
    <div class="content clear">
        ...
        <form id="popup_form" method="post">
            ...
            <div id="task">
                <input type="text" maxlength="100" title="Max 100 karaktera" style="width:300px;" name="task_name"
                       class="form-control" placeholder="<?php echo __('Naziv Cilja'); ?>" spellcheck="false"
                       required><br/>
            </div>

            <label><?php echo 'Opis cilja:'; ?></label>
            <div id="task">
                <textarea maxlength="250" rows="3" cols="50" name="task_description" placeholder="Unesite opis cilja..."
                          title="Max 250 karaktera" spellcheck="false"></textarea>
            </div>

            <?php if ($task_type != 2) { ?>
                <label><?php echo 'KPI:'; ?></label>
                <div id="kpi">
                    <textarea maxlength="80" rows="3" cols="30" name="task_kpi" placeholder="Unesite KPI..."
                              title="Max 80 karaktera" spellcheck="false"></textarea>
                </div>
            <?php } ?>
            ...
            <?php if ($task_type != 2) { ?>
                ...
                <div id="ponder1" class="" style="width:160px;display: -webkit-box;">
                    <input style="width:90px;height:30px;margin-right:10px;" type="text"
                           onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="ponder" name="ponder"
            ...
            <?php } ?>
            <textarea rows="3" maxlength="250" title="Max 250 karaktera" cols="50" name="comment"
