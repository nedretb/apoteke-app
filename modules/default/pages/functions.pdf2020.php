...
///////////////////// END CONFIG
    ...
    $html = '
		...
		<ol style="padding-left:0;">
			<li>Radnik Banke ' . $data['First Name'] . ' ' . $data['Last Name'] . ', JMBG: ' . $data['JMB'] . ', (Udaljem tekstu Radnik) ostvaruje pravo na korištenje godišnjeg odmora za ' . date('Y', strtotime($data['Insert Date'])) . '. godinu u trajanju od ' . $data['Total days'] . ' radna dana prema sljedećim kriterijima:<br />
			<ul>
