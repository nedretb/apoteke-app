                ...
                <div class="col-sm-9"><br/>
                    <div class="pull-right">
                        <?php if (($visible != 'N')) { ?>
                            ...
                            <a href="<?php echo $url . '/modules/' . $_mod . '/pages/popup_day_add_apsolute_corrections.php?year=' . $year['id'] . '&month=' . $month['id']; ?>"
                            ...
                            <a href="<?php echo $url . '/modules/' . $_mod . '/pages/popup_day_cancel_apsolute_corrections.php?year=' . $year['id'] . '&month=' . $month['id']; ?>"
                               data-widget="ajax" data-id="opt2" data-width="500"
...
//                }
        ...
        if (($day['corr_review_status'] != '0' and ($day['KindofDay'] != 'BHOLIDAY')) and (($termination['termination_date'] == '' or ($termination['termination_date'] != '' and $day['Date'] <= $termination['termination_date'])) and ($day['Date'] >= $termination['employment_date']))) {
            ...
            if (($day['weekday'] == '6' or $day['weekday'] == '7') and isAllowedStatusWeekend($day['corr_status']) == false) {
                ...
                echo '<a href="' . $url . '/modules/' . $_mod . '/pages/popup_day_view_corrections.php?id=' . $day['id'] . '" class=" table-btn-icons " data-widget="ajax" data-id="opt2" data-width="400"><i class="ion-eye"></i></a>';
            }
        ...
        if (($day['corr_review_status'] == '0') and ($day['weekday'] != '6') and ($day['weekday'] != '7') and ($day['KindofDay'] == 'BANKDAY' or ($day['KindofDay'] == 'BHOLIDAY' and $day['corr_review_status'] == '0')) and ($visible != 'N') and (($termination['termination_date'] == '' or ($termination['termination_date'] != '' and $day['Date'] <= $termination['termination_date'])) and ($day['Date'] >= $termination['employment_date']))) {
            echo '<a href="' . $url . '/modules/' . $_mod . '/pages/popup_day_edit_corrections.php?id=' . $day['id'] . '" class=" table-btn-icons " data-widget="ajax" data-id="opt2" data-width="400"><i class="ion-edit"></i></a>';
        }
        echo '</div>';
        echo '</div>';
        }
