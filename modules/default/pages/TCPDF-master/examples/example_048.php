...
$pdf->SetTitle('Obrazac za prijavu na eksterni seminar');
$pdf->SetSubject('(Popunjava radnik koji podnosi prijavu. Prijava se može izvršiti nakon što je zahtjev odobren. Napomena: ako se radi o grupnoj obuci, popunjava se samo jedan obrazac)');
...
<thead>
 <tr style="background-color:#006595;color:#0000FF;">
 ...
 <tr style="background-color:#FF0000;color:#006595;">
