            ...
            <form id="popup_form" method="post">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <select id="FromDay" style="padding:0px !important;" name="FromDay" class="form-control"
                                required>
                ...
                <button type="submit" name="submit" class="btn btn-red pull-right"><?php echo __('Spasi!'); ?> <i
