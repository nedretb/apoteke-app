...
if ($get->rowCount() < 0) {
    ...
    <section class="full">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-right"><br/>
                    <div class="pull-right">
                        ...
                        <a href="<?php echo $url . '/modules/' . $_mod . '/pages/popup_trainings_add.php'; ?>"
                           data-widget="ajax" data-id="opt2"
                           class="btn btn-red btn-lg"><?php echo __('Dodaj trening'); ?> <i
            ...
            <a href="/app/?m=default&p=trainings" class="btn btn-filter <?php if ($type == '') {
                echo 'active';
            } ?>"><?php echo __('Aktivni'); ?></a>
            <a href="/app/?m=default&p=trainings&t=3" class="btn btn-filter <?php if ($type == '3') {
                echo 'active';
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <br/>
                                    <?php echo __('Od:'); ?>
                                    <b><?php echo date('d/m/Y', strtotime($item['date_from'])); ?></b> &nbsp;
                                    <?php echo __('Do:'); ?>
                                    <b><?php echo date('d/m/Y', strtotime($item['date_to'])); ?></b><br/>
                                ...
                                <div class="col-sm-2 text-right">
                                    <?php if ($item['status'] == 0) { ?>
                                        ...
                                        <a href="<?php echo '/app/?m=users&p=popup_trainings_add_view&id=' . $tools_id; ?>"
                                           class="table-btn alt"><i class="ion-eye"></i></a>
                                    <?php } else { ?>
                                        <a href="<?php echo $url . '/modules/' . $_mod . '/ajax.php'; ?>"
                                           class="table-btn alt" data-widget="remove"
