        ...
        <form id="popup_form" method="post">
            ...
            <div id="position">
                <input type="text" name="position" class="form-control"
                       placeholder="<?php echo __('Naziv pozicije'); ?>" title="Unesite naziv pozicije!" required><br/>
            </div>


            <label><?php echo __('Naziv OJ:'); ?></label>
            <div id="OJ">
                <input type="text" name="OJ" class="form-control" placeholder="<?php echo __('Naziv OJ'); ?>"
                       title="Unesite naziv OJ!" required><br/>
            </div>
            ...
            <div id="napomena">
                <input type="text" name="napomena" class="form-control" placeholder="<?php echo __('Napomena'); ?>"
                <br/>
            </div>
