            ...
            <div class="row">
                ...
                <form id="popup_form1" method="post">
                    ...
                    <div class="row col-sm-12">
                        <div class="col-sm-1" style="width:9%;padding-right:0px;">
                        ...
                        <div class="col-sm-1" style="width:9%;padding-right:0px;">
                            <input type="text" name="dateTo" class="form-control" style="height:35px;" id="dateDO1"
                                ...
                                echo date('d.m.Y', strtotime("31-12-" . $year['year']));
                            } else {
                                echo date('d.m.Y', strtotime($number_of_days . "-" . $month_to . "-" . $year['year']));
                            } ?>">
                            <br/>
                        </div>
                        <div class="col-sm-1" style="width:6%;padding-right:0px;">

                            <input type="text" name="employee_no" class="form-control" style="height:35px;"
                                   id="employee_no" placeholder="pr. broj" title="Personalni broj radnika"
                        ...
                        <div class="col-sm-1" style="width:10%;margin-top: -25px;padding-right:0px;height:35px;">
                        ...
                        <div class="col-sm-1" style="margin-top: -25px;padding-right:0px;">
                            ...
                            <select style="padding:0px !important;height:35px; " name="vrsta" id="vrsta"
                        ...
                        <div class="col-sm-1" style="margin-top: -25px;padding-right:0px;">
                            ...
                            <select style="padding:0px !important; height:35px;" name="grupa" id="grupa"
                                    class="form-control" onchange="this.form.submit();">
                        ...
                        <div class="col-sm-2" style="width:13%;">
                            <button class="btn btn-danger" id="accept_all"
                                    style="width:150px; height:34px; text-align:left;"><?php echo __('Odobri izostanke'); ?> <i
                                        class="fa fa-check" style="padding-top:3px;" aria-hidden="true"></i></button>
                        </div>

                        <div class="col-sm-1">
                            <button class="btn btn-primary" id="open_export"
                                    style="width:auto; height:34px;"><?php echo __('Export'); ?> <i
                                        class="fa fa-download" style="padding-top:3px;" aria-hidden="true"></i></button>
                            <div class="export_dropdown">
                                <button id="export_excel_users" class="btn btn-excel"
                                        style="width:auto;"><?php echo __('Exportuj u Excel!'); ?> <i
                                            class="fa fa-file-excel-o" style="padding-top:3px;" aria-hidden="true"></i>
                                </button>
                                <br/><br/>
                                <button id="export_pdf_users" class="btn btn-pdf"
                                        style="width:auto;"><?php echo __('Exportuj u PDF!'); ?> <i
                                            class="fa fa-file-pdf-o" style="padding-top:3px;" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <input id="filter_doc" type="checkbox" <?php if ($filter_dokument) {
                            echo 'checked="checked"';
                        } ?> value="1" name="filter_doc" style="margin-bottom:10px;">
...
<script>
    ...
    $("#accept_all").click(function (e) {
        ...
        $.post("<?php echo $url . '/modules/' . $_mod . '/ajax.php'; ?>",
            {
                request: "accept-sve-radnici-corrections",
                date_od: $("#dateOD1").val(),
                date_do: $("#dateDO1").val()
            },
