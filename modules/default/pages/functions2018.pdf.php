...
///////////////////// END CONFIG
    ...
    if ($state == 'fbih') {
        ...
        $_text[0] = "Na osnovu čl. 112., 52. i 47. Zakona o radu (''Službene novine Federacije BiH\'' br. 26/16) i Odluke Uprave Banke broj: 1-9-52723-10/2016, donosim:";
        $_text[1] = "Članom 47. Zakona o radu (''Službene novine Federacije BiH'' br. 26/16) je definisano da Radnik/ca, za svaku kalendarsku godinu, ima pravo na plaćeni godišnji odmor u trajanju od najmanje 20 radnih dana.";
        ...
        $_text[0] = "Na osnovu čl. 198., 85. i 80. Zakona o radu (“Službeni glasnik Republike Srpske” broj: 1/16) i Odluke Uprave Banke broj: 1-9-52723-10/2016, donosim";
        $_text[1] = "";
        $_text[2] = "";
        ...
        $_text[0] = "Na osnovu čl. 86., 35. i 32. Zakona o radu (“Službeni glasnik Brčko Distrikta BiH”, br. 19/06, 19/07 i 25/08, 20/13, 31/14 i 1/15) i Odluke Uprave Banke broj: 1-9-52723-10/2016, donosim";
        $_text[1] = "Članom 32. Zakona o radu (“Službeni glasnik Brčko Distrikta BiH”, br. 19/06, 19/07 i 25/08, 20/13, 31/14 i 1/15) je definisano da Radnik/ca, za svaku kalendarsku godinu, ima pravo na plaćeni godišnji odmor u trajanju od najmanje 18 radnih dana.";
        $_text[2] = "";
        $_text[3] = "Imenovanoj/m";
    ...
    $html = '
		...
		<ol style="padding-left:0;">
			<li>Radnik/ca banke ' . $data['First Name'] . ' ' . $data['Last Name'] . ', JMBG: ' . $data['JMB'] . ', zaposlen/a na radnom mjestu ' . $data['position'] . ', ostvaruje pravo na korištenje godišnjeg odmora za ' . date('Y', strtotime($data['Insert Date'])) . '. godinu u trajanju od ' . $data['Total days'] . ' radna dana prema sljedećim kriterijima:<br />
			<ul>
				<li>U skladu sa Zakonom o radu - ' . $data['Legal Grounds'] . ' radnih dana;</li>
				<li>U skladu sa Odlukom Uprave Banke - ' . $data['Days based on Work experience'] . ' radna dana.</li>
			</ul>
			<br />
			</li>
			...
			<li>Preostali dio godišnjeg odmora Radnik/ca će koristiti u dogovoru sa poslodavcem, a najkasnije do 30. juna ' . date('Y', strtotime($data['Insert Date'] . " + 1 year")) . '. godine.<br /></li>
		...
		<BR />
		<BR />
		Odlukom Uprave Banke broj: 1-9-52723-10/2016 utvrđeno je trajanje godišnjeg odmora duže od minimalnog  na osnovu sljedećih kriterija:
		<BR />
		<BR />
		...
		Radnik, ako smatra da mu je ovim Rješenjem povrijeđeno neko pravo iz radnog odnosa, ima pravo u roku od 30 dana od dana dostave Rješenja, odnosno od dana saznanja za povredu prava, zahtijevati od Poslodavca ostvarivanje tog prava. Ako Poslodavac u roku od 30 dana od dana podnošenja zahtjeva ne udovolji zahtjevu, Radnik može u daljem roku od 90 dana podnijeti tužbu pred nadležnim sudom.
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
