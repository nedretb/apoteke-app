...
if (isset($_POST['request'])) {
    if ($_POST['request'] == 'datum-akontacije') {
        ...
        while ($tip == 'BHOLIDAY' or in_array($dan, [6, 7])) {
            ...
            $dan_data = $db->query("
    SELECT * FROM  " . $portal_hourlyrate_day . " 
where Date = '$date' and employee_no = (
select employee_no from  " . $portal_hourlyrate_day . "  where id = $id)
");
    ...
    if ($_POST['request'] == 'experience-add') {
        ...
        $data = "INSERT INTO  " . $portal_experience . "  (
    ...
    if ($_POST['request'] == 'lang-add') {
        ...
        $get = $db->query("SELECT max([Line No_]) as maximalni FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Relative] WHERE [Employee No_]='" . $_user['employee_no'] . "'");
        if ($get->rowCount() < 0)
            $maximalni = $get->fetchAll();

        $data = "INSERT INTO [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Qualification] (
    [Employee No_]
    ...
    if ($_POST['request'] == 'remove-kvalifikacija_remove') {
        ...
        $data = "DELETE FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Qualification] WHERE [Line No_] = " . $this_id . " AND [Employee No_] ='" . $_user['employee_no'] . "'";
    ...
    if ($_POST['request'] == 'remove-experience_remove') {
        $this_id = $_POST['request_id'];
        $data = "DELETE FROM  " . $portal_experience . "  WHERE id = ?";
        $delete = $db->prepare($data);
...
//////
        $check_year_exists_calendar = $db->query("SELECT * FROM  " . $portal_calendar . "  WHERE [Year]='" . $_POST['year'] . "'")->rowCount();
...
SELECT * FROM src
  ...
  OPTION (MAXRECURSION 0);");
        ...
        if ($check < 0) {
            ...
            $query = $db->query("SELECT top 1000  [user_id] FROM  " . $portal_users . "  where 
 ...
 ((termination_date is null) or (termination_date ='')) order by user_id offset 1000 rows");
  ...
  and ((termination_date>='" . $filtertdate . "') or (termination_date is null))  ");
   ...
   ");
    ...
    if ($_POST['request'] == 'parent-day-add_apsolute' or ($_POST['request'] == 'day-edit' and $_POST['status'] == 67)) {
        ...
        $emp = $db->query("SELECT employee_no, YEAR(Date) as godina FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "'  
  ");
        ...
        $get_count_holiday = $db->query("SELECT count(KindOfDay) as countHol FROM  " . $portal_hourlyrate_day . "  WHERE (KindOfDay='BHOLIDAY') and (
   ...
   and year_id=" . $getYear);
        ...
        $get_count_odobreno = $db->query("SELECT count(*) as countOdobreno FROM  " . $portal_hourlyrate_day . "  WHERE (review_status='1') and (KindofDay<>'BHOLIDAY') and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
  ...
  AND weekday<>'6' AND weekday<>'7' AND (status='79') AND (date_NAV is null)");
        ...
        if ($_POST['status'] == '67') {
            ...
            $get = $db->query("SELECT * FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee] WHERE [No_]='" . $emp_no . "'");
            if ($get->rowCount() < 0) {
...
//Upis pocetka bolovanja
  ...
  ");
   ...
   and year_id=" . $getYear);
        ...
        $get_count_odobreno = $db->query("SELECT count(*) as countOdobreno FROM  " . $portal_hourlyrate_day . "  WHERE (corr_review_status='1') and (KindofDay<>'BHOLIDAY') and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
   ...
   and year_id=" . $getYear);
        ...
        $currgo = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE ((year_id='" . $getYear . "' AND (corr_status='18')) or (year_id = '" . $nex_year . "' and corr_status = '19'))  AND weekday<>'6' AND weekday<>'7'  AND (date_NAV_corrections is null)");
   ...
   and year_id=" . $getYear);
        ...
        $currgoPG = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE ((year_id='" . $getYear . "' AND (corr_status='19')) or (year_id = '" . $pre_year . "' and corr_status = '18')) AND employee_no='" . $empid . "' 
  AND weekday<>'6' AND weekday<>'7' AND (date_NAV_corrections is null)");


        $currgototal = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND employee_no='" . $empid . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='19' or corr_status='18')");

        $death = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND employee_no='" . $empid . "' 
    AND weekday<>'6' AND weekday<>'7' AND (corr_status='72')");
        $pcm = $db->query("SELECT * FROM  " . $portal_vacation_statistics . "  WHERE employee_no='" . $empid . "' and year = '$godina'");
        $plo = $db->query("SELECT * FROM  " . $portal_vacation_statistics . "  WHERE employee_no='" . $empid . "' and year = '$godina'");
        $currplo = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND employee_no='" . $empid . "' 
  ...
  or (corr_status='32') or (corr_status='79'))");
        $currpcm = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='21')");
        $upcm = $db->query("SELECT * FROM  " . $portal_vacation_statistics . "  WHERE employee_no='" . $empid . "' and year = '$godina'");
        $currupcm = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='22')");

        $curruP_1 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='27')");
        $curruP_2 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='28')");
        $curruP_3 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='29')");
        $curruP_4 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='30')");
        $curruP_5 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='31')");
        $curruP_6 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='32')");
        $curruP_7 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "'  
  ...
  WHERE 
   ...
   and ([Date] >= '" . $pocetak_bolovanja['pocetak_bolovanja'] . "' and [Date] < '" . $dateFromDB . "') and year_id=" . $getYear);
            ...
            $get_previous_days = $db->query("SELECT corr_status, KindOfDay, weekday FROM  " . $portal_hourlyrate_day . "  
  WHERE 
   ([Date] in ('" . $previous_day . "','" . $previous_day_1 . "','" . $previous_day_2 . "','" . $previous_day_3 . "','" . $previous_day_4 . "')) and year_id=" . $getYear . " order by [Date] DESC");
 ...
 and [Date] >='" . $_user['employment_date'] . "'";
  ...
  and id = case when ([weekday] = '6' or [weekday] = '7') and 1=$not_allowed then 0 else [id] end";
   ...
   and year_id=" . $getYear);
        ...
        $get_count2 = $db->query("SELECT count(*) as not_redovni FROM  " . $portal_hourlyrate_day . "  WHERE ((status='5' and hour != '0' and weekday in (6,7)) or (status != '5')) and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
...
join c0_intranet2_apoteke.dbo.hourlyrate_year as y on u.user_id = y.user_id where y.id = $getYear) end,
   ...
   and year_id=?
    ...
    if ($_POST['request'] == 'parent-day-cancel_apsolute_corrections') {
        ...
        $get_statuses = $db->query("SELECT corr_status FROM  " . $portal_hourlyrate_day . "  WHERE (corr_status<>'5') and (
     (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
     (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
     ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
     (month_id > " . $month_from . " and month_id < " . $month_to . ")
     ...
     and year_id=" . $getYear);
        ...
        $get_count1 = $db->query("SELECT count(*) as countOdobreno FROM  " . $portal_hourlyrate_day . "  WHERE (corr_review_status='1') and (KindofDay<>'BHOLIDAY') and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
   ...
   and year_id=" . $getYear);
        ...
        $get_count2 = $db->query("SELECT count(*) as not_redovni FROM  " . $portal_hourlyrate_day . "  WHERE (corr_status<>'5') and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
   ...
   and year_id=" . $getYear);
        ...
        $get_count_praznik = $db->query("SELECT COUNT(*) as not_praznik  FROM  " . $portal_hourlyrate_day . "  WHERE ( corr_status = '83' and KindOfDay = 'BHOLIDAY')  and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
   ...
   and year_id=" . $getYear);
        ...
        $get_count3 = $db->query("SELECT count(*) as req_sent FROM  " . $portal_hourlyrate_day . "  WHERE (corr_change_req='1') and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
  ...
  hour = case when (weekday in (6,7)) then 0
   ...
   and year_id=?
    ...
    if ($_POST['request'] == 'day-edit' and $_POST['status'] != '67') {
        ...
        $get_old_status = $db->query("SELECT status, KindOfDay, review_status, corr_review_status FROM  " . $portal_hourlyrate_day . "  WHERE id='" . $this_id . "'  ");
  ...
  AND weekday<>'6' AND weekday<>'7' AND (status='21') AND (date_NAV is null)");
        ...
        $currupcm = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' 
  AND weekday<>'6' AND weekday<>'7' AND (status='22') AND (date_NAV is null)");
        $checkva = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' and employee_no='" . $empid . "'
   and status='19'  ");
  ...
  AND weekday<>'6' AND weekday<>'7' AND (status='32') AND (date_NAV is null)");
     ...
     and weekday<>'6' AND weekday<>'7' AND (status='79') AND (date_NAV is null)");
        ...
        if ($_POST['status'] == '67') {
            ...
            $get = $db->query("SELECT * FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee] WHERE [No_]='" . $_user['employee_no'] . "'");
            if ($get->rowCount() < 0)
                $row_employee = $get->fetch();
            $entitet = $row_employee['Org Entity Code'];
            ...
            $get_date_id = $db->query("SELECT Date as datum FROM  " . $portal_hourlyrate_day . "  where 
    id = " . $this_id);
    ...
    user_id = " . $_user['user_id']);
            ...
            if ($pocetak_bolovanja['pocetak_bolovanja'] == '')
                ...
                $get_bolovanje43 = $db->query("SELECT count(*) as bolovanje43 FROM  " . $portal_hourlyrate_day . "  h
...
//NK
    ...
    if ($_POST['request'] == 'day-edit_corrections' and $_POST['status'] != 67) {
        ...
        $get_old_status = $db->query("SELECT corr_status, corr_review_status, KindOfDay FROM  " . $portal_hourlyrate_day . "  WHERE id='" . $this_id . "'  ");
        $old_status = $get_old_status->fetch();
  ...
  AND weekday<>'6' AND weekday<>'7' AND (date_NAV_corrections is null)");
        ...
        $currgo = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "'  
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='18')");
        $currgoPG = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' AND employee_no='" . $empid . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='19')");


        $currgototal = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' AND employee_no='" . $empid . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='19' or corr_status='18')");
        $death = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' AND employee_no='" . $empid . "' 
    AND weekday<>'6' AND weekday<>'7' AND (corr_status='72')");
        $pcm = $db->query("SELECT * FROM  " . $portal_vacation_statistics . "  WHERE employee_no='" . $empid . "'  and year = '$godina'");
        $currpcm = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='21')");
        ...
        $currupcm = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='22')");
        $checkva = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' and month_id='" . $getMonth . "'and employee_no='" . $empid . "'
   and corr_status='19'  ");

        $currplo = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' AND employee_no='" . $empid . "' 
  AND weekday<>'6' AND weekday<>'7' AND ((corr_status='27') or (corr_status='28') or (corr_status='29') or (corr_status='30') or (corr_status='31')   
  or (corr_status='32') or (corr_status='79'))");
        ...
        $P_6a = $db->query("SELECT * FROM  " . $portal_hourlyrate_status . "  WHERE id='32'");
        $P_7a = $db->query("SELECT * FROM  " . $portal_hourlyrate_status . "  WHERE id='79'");
        $curruP_1 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='27')");
        $curruP_2 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='28')");
        $curruP_3 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='29')");
        $curruP_4 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='30')");
        $curruP_5 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='31')");
        $curruP_6 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' 
  AND weekday<>'6' AND weekday<>'7' AND (corr_status='32')");
        $curruP_7 = $db->query("SELECT sum(" . $br_sati . ") as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $getYear . "' AND month_id='" . $getMonth . "' 
     and weekday<>'6' AND weekday<>'7' AND (corr_status='79')");
...
//NK
        ...
        if ($old_status['corr_review_status'] == '1' and !(($old_status['KindOfDay'] == 'BHOLIDAY') and in_array($_POST['status'], array(43, 44, 45, 61, 62, 65, 67, 68, 69, 74, 75, 76, 77, 78, 73, 81, 107, 108)))) {
            echo '<div class="alert alert-danger"><b>' . __('Greška!') . '</b><br/>' . __('Ne možete promjeniti odobrenu registraciju!') . '</div>';
            return;
        }
        if (($totalgoost - 1 < 0) and $_POST['status'] == '18') {
    ...
    {
        global $db, $portal_users, $portal_hourlyrate_year, $portal_hourlyrate_day;
        $_user = _user(_decrypt($_SESSION['SESSION_USER']));
        ...
        if ($_user['role'] == 4) {
            $get2 = $db->query("SELECT DISTINCT  " . $portal_users . " .user_id, s1.id as yearid FROM  " . $portal_users . "  JOIN  " . $portal_hourlyrate_year . "  s1 ON s1.user_id =  " . $portal_users . " .user_id and s1.year = '$yearChose' WHERE " . $_user['employee_no'] . " in ( " . $portal_users . " .admin1, " . $portal_users . " .admin2, " . $portal_users . " .admin3, " . $portal_users . " .admin4, " . $portal_users . " .admin5)  ");
            $result = $get2->fetchAll();
            $total_users = $result;
        } elseif ($_user['role'] == 2) {
            $get2 = $db->query("SELECT DISTINCT  " . $portal_users . " .user_id, s1.id as yearid FROM  " . $portal_users . "  JOIN  " . $portal_hourlyrate_year . "  s1 ON s1.user_id =  " . $portal_users . " .user_id and s1.year = '$yearChose' WHERE ( " . $portal_users . " .parent='" . $_user['employee_no'] . "')");
            $result = $get2->fetchAll();
            $total_users = $result;
        }
        ...
        $get_days = $db->query("SELECT  " . $portal_hourlyrate_day . " .id FROM  " . $portal_hourlyrate_day . "  
            
            INNER JOIN  " . $portal_hourlyrate_year . "  s1 ON  " . $portal_hourlyrate_day . " .user_id = s1.user_id and s1.year = '$yearChose'
            WHERE
               " . $portal_hourlyrate_day . " .user_id IN $arr and
               " . $portal_hourlyrate_day . " .$column_kor = 0 
              and  " . $portal_hourlyrate_day . " .year_id = s1.id and  
              
               " . $portal_hourlyrate_day . " .status NOT IN (5,43,44,45,61,62,65,67,68,69,72, 74,75,76,77,78,79,80,105,107,108) and
    ...
    if ($_POST['request'] == 'change-odobreno') {
        ...
        $get_count = $db->query("SELECT count(*) as countReq FROM  " . $portal_hourlyrate_day . "  WHERE (change_req='1') and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
   ...
   and year_id=" . $year_id);
        ...
        $emp = $db->query("SELECT user_id, employee_no FROM  " . $portal_hourlyrate_day . "  WHERE year_id=" . $year_id);
        foreach ($emp as $valueemp) {
            $empid = $valueemp['employee_no'];
   ...
   and year_id=" . $year_id);
        ...
        $currplo = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $year_id . "' AND employee_no='" . $empid . "' 
  AND weekday<>'6' AND weekday<>'7' AND ((status='27') or (status='28') or (status='29') or (status='30') or (status='31')   
  or (status='32') or (status='79')) AND (date_NAV is null)");

        $curruP_1 = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $year_id . "' AND weekday<>'6' AND weekday<>'7' AND (status='27') AND (date_NAV is null)");
        $curruP_2 = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $year_id . "' AND weekday<>'6' AND weekday<>'7' AND (status='28') AND (date_NAV is null)");
        $curruP_3 = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $year_id . "' AND weekday<>'6' AND weekday<>'7' AND (status='29') AND (date_NAV is null)");
        $curruP_4 = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $year_id . "' AND weekday<>'6' AND weekday<>'7' AND (status='30') AND (date_NAV is null)");
        $curruP_5 = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $year_id . "' AND weekday<>'6' AND weekday<>'7' AND (status='31') AND (date_NAV is null)");
        $curruP_6 = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $year_id . "' AND weekday<>'6' AND weekday<>'7' AND (status='32') AND (date_NAV is null)");
        $curruP_7 = $db->query("SELECT sum(hour) as sum_hour FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $year_id . "' AND weekday<>'6' AND weekday<>'7' AND (status='79') AND (date_NAV is null)");
        ...
        $get_count1 = $db->query("SELECT count(*) as countNotHoliday FROM  " . $portal_hourlyrate_day . "  WHERE (KindOfDay<>'BHOLIDAY') and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
   ...
   and year_id=" . $year_id);
        ...
        if ($_POST['odobreno'] == '2') {
            ...
            if (isset($_POST['data_otkazivanje'])) {
                if ($_POST['data_otkazivanje'] == "1") {
                    ...
                    $get_userid = $db->query("SELECT user_id FROM  " . $portal_users . "  WHERE employee_no='" . $employee_no_post . "'");
                    $fetchuser = $get_userid->fetchAll();
                    $fetched_user_id = $fetchuser[0]['user_id'];


                    $data1 = "INSERT INTO  " . $portal_canceledreq . "  
      ...
      ";
            ...
            $get_status = $db->prepare("SELECT status, review_comment FROM  " . $portal_hourlyrate_day . "  WHERE  (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
   ...
   and year_id=" . $year_id);
            ...
            $get_year = $db->prepare("SELECT  year FROM  " . $portal_hourlyrate_year . "  WHERE id = '$year_id'");
            $get_year->execute();
   ...
   and year_id=?
    ...
    if ($_POST['request'] == 'change-odobreno_corrections') {
        ...
        $get_count = $db->query("SELECT count(*) as countReq FROM  " . $portal_hourlyrate_day . "  WHERE (corr_change_req='1') and (
   (day >= " . $day_from . " and month_id = " . $month_from . " and (" . $month_from . " <> " . $month_to . "))  OR
   (day <= " . $day_to . " and month_id = " . $month_to . " and (" . $month_to . " <> " . $month_from . ")) OR
   ((day >= " . $day_from . " and day <= " . $day_to . ") and month_id = " . $month_from . " and month_id = " . $month_to . ") OR
   (month_id > " . $month_from . " and month_id < " . $month_to . ")
   ...
   and year_id=?
    ";
            ...
            $yearq = $db->query("select * from  " . $portal_hourlyrate_year . "  where id = $year_id");
            $yearq = $yearq->fetch();

            $get_statuses = $db->query("SELECT * FROM  " . $portal_hourlyrate_day . "  WHERE year_id = $year_id and Date between '" . $yearq['year'] . '-' . $month_from . '-' . $day_from . "' and '" . $yearq['year'] . '-' . $month_to . '-' . $day_to . "'  ");
            $fetch_statuses = $get_statuses->fetchAll();
            ...
            if ($send_email) {
                mail_cancel_trip($day_from . '.' . $month_from . '.' . $yearq['year'], $day_to . '.' . $month_to . '.' . $yearq['year'], $statuss, $year_id);
            }
            //
        } elseif ($_POST['odobreno'] == '0') {
            date_default_timezone_set('Europe/Sarajevo');
...
// Redirect output to a client’s web browser (PDF)
    ...
    if ($_POST['request'] == 'export-pdf-reif-users2') {
        ...
        $get_year = $db->query("SELECT year FROM  " . $portal_hourlyrate_year . "  WHERE year='" . $godina . "' AND user_id = " . $_user['user_id']);
        $year_real = $get_year->fetch();


        $arr = array();

        $get = $db->query("SELECT TOP 10 h.id, h.status, h.employee_no, h.day, h.month_id, h.Description, h.$col_name FROM  " . $portal_hourlyrate_day . "  h 
    join  " . $portal_hourlyrate_year . "  y
    on h.year_id = y.id
    join  " . $portal_calendar . "  c
    on (c.Year = y.year and c.Day = h.day and c.Month=h.month_id)
...
// Redirect output to a client’s web browser (PDF)
    ...
    if ($_POST['request'] == 'profile-edit') {
        ...
        $get = $db->query("SELECT * FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee] WHERE [No_]='" . $this_id . "'");
        if ($get->rowCount() < 0)
        ...
        if (isset($_FILES['media_file'])) {
            if (is_uploaded_file($_FILES['media_file']['tmp_name'])) {
                ...
                if ($_FILES["media_file"]["type"] == "image/jpeg" || $_FILES["media_file"]["type"] == "image/jpg") {
                    ...
                    $destination_upload = 'D:/Temp/uploads/raiff/' . $this_id . ".jpeg";
...
// hm 01 end
        ...
        $get = $db->query("SELECT * FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Relative] WHERE [Employee No_]='" . $this_id . "' AND [Relative Code] = 'OTAC'");
        if ($get->rowCount() < 0)
            $row_otac = $get->fetchAll();

        $get = $db->query("SELECT * FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Relative] WHERE [Employee No_]='" . $this_id . "' AND [Relative Code] = 'MAJKA'");
        if ($get->rowCount() < 0)
            $row_majka = $get->fetchAll();

        $get = $db->query("SELECT * FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Relative] WHERE [Employee No_]='" . $this_id . "' AND [Relative Code] = N'SUPRUŽNIK'");
        if ($get->rowCount() < 0)
...
// hm 02 kod od 6509 do 6542
        ...
        $this_id = $_POST['request_id'];
        $data = "UPDATE [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee] SET
    ...
    where [No_] = ?";
        ...
        if ($count_otac > 0) {
            ...
            $data = "UPDATE [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Relative] SET
    [First Name] = ?,
    [Last Name] = ?,
    [Birth Date] = ?
    WHERE [Employee No_] = ?
    AND [Relative Code] = 'OTAC'";
            ...
            $get = $db->query("SELECT max([Line No_]) as maximalni FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Relative] WHERE [Employee No_]='" . $this_id . "'");
            if ($get->rowCount() < 0)
                $maximalni = $get->fetchAll();

            $data = "INSERT INTO [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Relative] ([Employee No_],[Line No_],
...
VALUES (?, ?, ?, ?, ?,?, ?, ?, ?, ?,?, ?, ?, ?, ?,?, ?, ?, ?, ?)";
        ...
        if (isset($_POST['nivo_jezik'])) {
            ...
            foreach ($ukupni_jezici as $key => $nivo) {
                $data2 = "UPDATE [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Qualification] SET [Language Level] = " . $nivo['nivo_jezik'] . ", [Language Name]= '" . $nivo['jezik'] . "' WHERE [Line No_] = " . $nivo['line_no'] . " AND [Employee No_] ='" . $this_id . "'";
        ...
        if (isset($_POST['certifikat_opis'])) {
            ...
            foreach ($ukupni_certifikati as $key => $certifikat) {
                $data2 = "UPDATE [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Employee Qualification] SET [Description] = '" . $certifikat['opis'] . "', [Institution_Company]= '" . $certifikat['kompanija'] . "' WHERE [Line No_] = " . $certifikat['line_no'] . " AND [Employee No_] ='" . $this_id . "'";
    ...
    zamjenik = " . $_POST['zamjenik'] . " where employee_no ='" . _employee($this_id)['employee_no'] . "'";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parent2 = " . $_POST['zamjenik'] . " where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parent='" . _employee($this_id)['employee_no'] . "'))";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parentMBO2d = " . $_POST['zamjenik'] . " where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parentMBO2='" . _employee($this_id)['employee_no'] . "'))";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parentMBO3d = " . $_POST['zamjenik'] . " where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parentMBO3='" . _employee($this_id)['employee_no'] . "'))";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parentMBO4d = " . $_POST['zamjenik'] . " where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parentMBO4='" . _employee($this_id)['employee_no'] . "'))";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parentMBO5d = " . $_POST['zamjenik'] . " where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parentMBO5='" . _employee($this_id)['employee_no'] . "'))";
    ...
    zamjenik = NULL where employee_no ='" . _employee($this_id)['employee_no'] . "'";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parent2 = 0 where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parent='" . _employee($this_id)['employee_no'] . "'))";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parentMBO2d = 0 where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parentMBO2='" . _employee($this_id)['employee_no'] . "'))";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parentMBO3d = 0 where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parentMBO3='" . _employee($this_id)['employee_no'] . "'))";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parentMBO4d = 0 where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parentMBO4='" . _employee($this_id)['employee_no'] . "'))";
            ...
            $data = "UPDATE  " . $portal_users . "  SET
    parentMBO5d = 0 where employee_no in (SELECT employee_no FROM  " . $portal_users . "  WHERE (parentMBO5='" . _employee($this_id)['employee_no'] . "'))";
  ...
  where [No_] = ?";
    ...
    if ($_POST['request'] == 'insert-srodnik') {
        ...
        $code_srodstva = $db->query("SELECT [Code] as sifras FROM [NAV RAIFFEISEN].[dbo].[RAIFFEISEN RAIFFEISEN INVEST\$Relative] WHERE [Code]='" . $_POST['srodstvo'] . "'");
...
//$mail->addBCC('bcc@example.com');
    ...
    if ($_POST['request'] == 'get-info') {
        ...
        /*
  $get_accepted = $db->query("SELECT [request_id] FROM  ".$portal_hourlyrate_day."
    join  ".$portal_hourlyrate_year."  on
   ".$portal_hourlyrate_day." .year_id =  ".$portal_hourlyrate_year." .id
    WHERE
   (
   ...
   and year = ".$godina." GROUP BY [request_id]");
     $result2 = $get_accepted->fetchAll();*/
        ...
        /*
         $get_pending = $db->query("SELECT [request_id] FROM  ".$portal_hourlyrate_day."
       join  ".$portal_hourlyrate_year."  on
   ".$portal_hourlyrate_day." .year_id =  ".$portal_hourlyrate_year." .id
       WHERE
   (
   ...
   and year = ".$godina." GROUP BY [request_id]");
     $result2 = $get_pending->fetchAll();*/
        ...
        /*
    $get_accepted_corrections = $db->query("SELECT [request_id] FROM  ".$portal_hourlyrate_day."
    join  ".$portal_hourlyrate_year."  on
   ".$portal_hourlyrate_day." .year_id =  ".$portal_hourlyrate_year." .id
    WHERE
   (
   ...
   and year = ".$godina." GROUP BY [request_id]");
     $result2 = $get_accepted_corrections->fetchAll();*/
        ...
        /*
         $get_pending_corrections = $db->query("SELECT [request_id] FROM  ".$portal_hourlyrate_day."
       join  ".$portal_hourlyrate_year."  on
   ".$portal_hourlyrate_day." .year_id =  ".$portal_hourlyrate_year." .id
       WHERE
   (
   ...
   and year = ".$godina." GROUP BY [request_id]");
     $result2 = $get_pending_corrections->fetchAll();*/
        ...
        /*
           $get_rejected = $db->query("SELECT [request_id] FROM  ".$portal_hourlyrate_day."
       join  ".$portal_hourlyrate_year."  on
   ".$portal_hourlyrate_day." .year_id =  ".$portal_hourlyrate_year." .id
       WHERE
   (
   ...
   and timest_edit is not null GROUP BY [request_id]");
     $result2 = $get_rejected->fetchAll();*/
        ...
        /*
    $get_accepted_cancel = $db->query("SELECT [request_id] FROM  ".$portal_hourlyrate_day."
    join  ".$portal_hourlyrate_year."  on
   ".$portal_hourlyrate_day." .year_id =  ".$portal_hourlyrate_year." .id
    WHERE
   (
   ...
   and year = ".$godina." GROUP BY [request_id]");
     $result3 = $get_accepted_cancel->fetchAll();*/
        ...
        /*
    $get_rejected_cancel = $db->query("SELECT [request_id] FROM  ".$portal_hourlyrate_day."
    join  ".$portal_hourlyrate_year."  on
   ".$portal_hourlyrate_day." .year_id =  ".$portal_hourlyrate_year." .id
    WHERE
   (
