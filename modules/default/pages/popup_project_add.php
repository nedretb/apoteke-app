        ...
        <form id="popup_form" method="post">
            ...
            <div id="project_name">
                <input type="text" name="project_name" class="form-control"
                       placeholder="<?php echo __('Naziv projekta'); ?>" title="Unesite naziv projekta!" required><br/>
            </div>

            <label><?php echo __('Područje:'); ?></label>
            <div id="area">
                <input type="text" name="area" class="form-control" placeholder="<?php echo __('Područje'); ?>"
                       title="Unesite područje!" required><br/>
            </div>
            ...
            <div id="poslodavac">
                <input type="text" name="poslodavac" class="form-control" placeholder="<?php echo __('Poslodavac'); ?>"
                       title="Unesite poslodavca!" required><br/>
            </div>

            <label><?php echo __('Uloga u projektu:'); ?></label>
            <div id="uloga">
                <input type="text" name="uloga" class="form-control" placeholder="<?php echo __('Uloga u projektu'); ?>"
                       title="Unesite ulogu u projektu!" required><br/>
            </div>
