...
<section class="full">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 text-right"><br/>
                <div class="pull-right">
                    ...
                    <a href="<?php echo $url . '/modules/' . $_mod . '/pages/popup_requests_add.php'; ?>"
        ...
        <a href="/app/?m=default&p=requests" class="btn btn-filter <?php if ($type == '') {
            echo 'active';
        } ?>"><?php echo __('Aktivni'); ?></a>
        <a href="/app/?m=default&p=requests&t=3" class="btn btn-filter <?php if ($type == '3') {
            echo 'active';
                ...
                foreach ($query as $item) {
                    ...
                    <div class="col-sm-9" style="text-align:left;">
                        <div class="box box-lborder box-lborder-<?php echo $border; ?>"
                             id="opt-<?php echo $tools_id; ?>" style="width:950px;">
                            <div class="content" style="display: block;">
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        <?php echo __('Do:'); ?>
                                        <b><?php echo date('d/m/Y', strtotime($item['h_to'])); ?></b>
