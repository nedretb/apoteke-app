...
foreach ($users as $user){
    $data = Soap::getData('http://172.16.10.38:5203/PRH_WS/WS/JU%20Apoteke%20Sarajevo/Page/PRHWS_Employee', 'Read', ['No' => $user['employee_no']]);

    if(!empty($data->ReadMultiple_Result->PRHWS_Employee)){
