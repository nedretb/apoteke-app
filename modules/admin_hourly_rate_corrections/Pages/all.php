...
<div class="header">
    ...
    <h4><span><?php echo __('Korekcije'); ?></span></h4>
</div>
...
<section>
                        ...
                        <div class="row" style="display:block;">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div style="display:block;">
                                    ...
                                    <div class="small-circle"
                                         style="background:blue;border:1px solid gray;margin-left:39px;"></div> <?php echo __('Bolovanje'); ?>
                                </div>
                                ...
                                <tr id="opt-<?php echo $tools_id; ?>">
                                    ...
                                    <td class="text-center" class="hidden-xs">
                                        ...
                                        <?php if ($item['picture'] != 'none') { ?>
                                            <img onclick="$('#ime_prezime').val('<?php echo $item['First Name'] . ' ' . $item['Last Name']; ?>').change();"
                                    ...
                                    <td><a href="javascript:;"
                                           onclick="$('#ime_prezime').val('<?php echo $item['First Name'] . ' ' . $item['Last Name']; ?>').change();"><?php echo $item['First Name'] . ' ' . _optionGetLastNameNAV($item['employee_no']); ?></a><br/><small><?php echo $item['position']; ?>
  ...
  AND weekday<>'6' AND weekday<>'7' AND ((corr_status='27') or (corr_status='28') or (corr_status='29') or (corr_status='30') or (corr_status='31') or (corr_status='32') or (corr_status='79')   
  ) ");
  ...
  status_group='P – PLACENO ODSUSTVO' ");
                            ...
                            $edit = $db->query("SELECT editable_corrections FROM  " . $portal_hourlyrate_day . "  WHERE year_id='" . $absence_year . "' AND month_id='" . $month['id'] . "' AND employee_no='" . $item['employee_no'] . "' "); ?>
                    ...
                    foreach ($get_days as $day) { ?>
                        ...
                        if ($oboji) {
                            ...
                            if (($day['weekday'] != '6') and ($day['weekday'] != '7') and ($day['KindofDay'] == 'BHOLIDAY') and (rtrim(_nameHRstatusGroup($day['corr_status'])) != 'Bolovanje' and rtrim(_nameHRstatusGroup($day['corr_status'])) != 'Godišnji odmor')) {
                                ...
                                /* Test 110 */
                                if (($day['corr_review_status'] == '1' or $day['corr_review_status'] == '0')):
                        ...
                        if (($day['weekday'] == '6') and (($day['hour_pre'] != '' and $day['hour_pre'] != '0') or ($day['hour'] != 0 and in_array($day['corr_status'], array(5, 85, 86, 87, 88, 89, 90))) or in_array($day['corr_status'], array(73, 81)))) {
                            echo '<small>' . $day['day'] . '.' . $day['month_id'] . '<br/><b>Subota</b><br/>' . $status_prekid . $prekovremeno . $reg . '</small>';
                        } elseif (($day['weekday'] == '6') and !in_array($day['corr_status'], array(73, 81)) and (($day['hour_pre'] == '' and $day['hour'] == 0) or !in_array($day['status'], array(5, 85, 86, 87, 88, 89, 90)))) {
                        ...
                        if (($day['corr_review_status'] == '0') and ((($day['weekday'] != '6') and ($day['weekday'] != '7')) or $_user['employee_no'] == $contact_center_admin['Administrator Contact Center']) and ($visible != 'N') and (($termination['termination_date'] == '' or ($termination['termination_date'] != '' and $day['Date'] <= $termination['termination_date'])) and ($day['Date'] >= $termination['employment_date']))) {
