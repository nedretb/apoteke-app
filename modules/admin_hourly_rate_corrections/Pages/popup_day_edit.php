...
$religious_holiday = $db->query("SELECT KindofDay as Kind_ofDay FROM  " . $portal_hourlyrate_day . "  WHERE KindofDay='CHOLIDAY'");
    ...
    <div class="content clear">
        ...
        if ($get->rowCount() < 0) {
            ...
            order by c desc ");
                        ...
                        ?>
                        <input onchange="validate_hours();" type="number" name="hour" id="hour"
                               value="<?php echo $get_hour['hour']; ?>" min="0" max="24"
                               class="form-control" <?php if (!$cc_admin) {
                            echo 'readonly';
                        } ?>>
                    </div>
                    <div class="col-sm-5">
                ...
                <div class="row" <?php if (!$cc_admin) {
                    ...
                    <div class="col-sm-4">
                        ...
                        <input onchange="validate_hours();" type="text" name="hour_pre" id="hour_pre"
                               value="<?php echo $row['hour_pre']; ?>" class="form-control">
                    </div>
                    <div class="col-sm-5">
                        ...
                        <select style="padding:0px !important; " name="status_pre" id="status_pre" class="form-control">
                            <?php
                            if ($cc_admin) {
                                echo _optionHRstatusPre($row['status_pre']);
                            }
                            ?>          </select>
                    </div>
                </div>
