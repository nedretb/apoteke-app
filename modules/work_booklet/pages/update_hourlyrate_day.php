...
foreach ($hourlyDayStatus as $singleStatus){
    ...
    //praznik drzavni
    elseif (in_array($singleStatus['status'], array(83, 146))){
        $updateStatus = 1026;
    }

    //Plaćeno odsustvo
    elseif (in_array($singleStatus['status'], array(27, 28, 29, 30, 31, 32, 79, 80, 145))){
        $updateStatus = 1020;
    }

    //Bolovanje povreda na radu preko 42 dana
    elseif (in_array($singleStatus['status'], array(130, 131))){
        $updateStatus = 1031;
    }
