        ...
        <form id="popup_form" method="post">
          ...
          <?php echo __('Broj sati'); ?> <b><?php echo $row['hour']; ?></b>-->
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div id="dt">
                        <input type="text" name="dateFrom" class="form-control" style="width:120px;" value="01.<?php echo $_GET['month']; ?>.<?php echo $year['year']; ?>" id="dateOD" placeholder="dd/mm/yyyy" title="" required>
                    </div><br/>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div id="dt">
                        <input type="text" name="dateTo" class="form-control" style="width:120px;" value="01.<?php echo $_GET['month']; ?>.<?php echo $year['year']; ?>" id="dateDO" placeholder="dd/mm/yyyy" title="" required>
                    </div><br/>
                </div>
            </div>
          ...
          <select style="padding:0px !important; " name="status" class="form-control" required>
            <?php echo _optionHRstatus($row['status']); ?>
                ...
                <button style="margin-left:15px;     margin-top: 10px;" type="submit" class="btn btn-red "><?php echo __('Spasi!'); ?> <i class="ion-ios-download-outline"></i></button>
