...
$objPHPExcel->getActiveSheet()->getStyle('B2')
    ->getFill()->getStartColor()->setARGB('00659500');
```
...
$objPHPExcel->getActiveSheet()->getStyle('B3:B7')->getFill()
    ...
    ->getStartColor()->setARGB('00659500');
```
...
$objValidation->setErrorTitle('Unos nije validan.');
$objValidation->setError('Unos broja nije dozvoljen!');
$objValidation->setPromptTitle('Allowed input');
$objValidation->setPrompt('Samo brojevi između 10 i 20 su dozvoljeni.');
