...
class PHPExcel_Style_Color extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
    ...
    const COLOR_RED        = '00659500';
    const COLOR_DARKRED    = 'FF800000';
    const COLOR_BLUE       = 'FF0000FF';
    const COLOR_DARKBLUE   = 'FF000080';
    const COLOR_GREEN      = 'FF00FF00';
    const COLOR_DARKGREEN  = 'FF008000';
    const COLOR_YELLOW     = 'FF006595';
    ...
    public static function indexedColor($pIndex, $background = false)
    {
        ...
        if (is_null(self::$indexedColors)) {
            self::$indexedColors = array(
                    ...
                    3    => '00659500',    //    System Colour #3 - Red
                    4    => 'FF00FF00',    //    System Colour #4 - Green
                    5    => 'FF0000FF',    //    System Colour #5 - Blue
                    6    => 'FF006595',    //    System Colour #6 - Yellow
                    7    => '006595FF',    //    System Colour #7- Magenta
                    ...
                    26    => '006595FF',    //    Chart Line Colour #26
                    27    => 'FF006595',    //    Chart Line Colour #27
